...
var compose_receiver_1 = __importDefault(require("../receivers/compose-receiver"));
var InitCommand = /** @class */ (function (_super) {
    ...
    InitCommand.prototype.setReceiver = function () {
        ...
        switch (this.entity) {
            ...
            case entity_1.default.Frontend:
                this.receiver = new frontend_receiver_1.default(ctx, false);
                this.receiver.result.on('mdb.cli.live.output', function (msg) { return _this.printResult([msg]); });
                break;
            case entity_1.default.Backend:
                this.receiver = new backend_receiver_1.default(ctx, false);
                break;
            case entity_1.default.Compose:
                this.receiver = new compose_receiver_1.default(ctx);
                this.receiver.result.on('mdb.cli.live.output', function (msg) { return _this.printResult([msg]); });
                break;
            ...
            case entity_1.default.Wordpress:
                this.receiver = new wordpress_receiver_1.default(ctx, false);
                this.receiver.result.on('mdb.cli.live.output', function (msg) { return _this.printResult([msg]); });
                break;
        }
    };
    InitCommand.prototype.startWizard = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        projectTypeChoices = this._getProjectTypeOptions();
                        _a = this.entity;
                    ...
                    case 2:
                        ...
                        _b = projectType;
                        switch (_b) {
                            case 'frontend': return [3 /*break*/, 3];
                            case 'backend': return [3 /*break*/, 5];
                            case 'blank': return [3 /*break*/, 7];
                            case 'wordpress': return [3 /*break*/, 8];
                        }
                        return [3 /*break*/, 10];
                    case 3: return [4 /*yield*/, this.frontendWizardForm()];
                    case 4:
                        _c.sent();
                        return [3 /*break*/, 10];
                    case 5: return [4 /*yield*/, this.backendWizardForm()];
                    case 6:
                        _c.sent();
                        return [3 /*break*/, 10];
                    case 7:
                        ...
                        this.setReceiver();
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this.wordpressWizardForm()];
                    case 9:
                        _c.sent();
                        return [3 /*break*/, 10];
    ...
    InitCommand.prototype.frontendWizardForm = function () {
        return __awaiter(this, void 0, void 0, function () {
            var versionChoices, mdbVersion, frontChoices, frontTechnology, licenseChoices, licenseType, technology, availableStarters, starter;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        versionChoices = [{ name: 'MDB 4', short: 'MDB 4', value: 'MDB4' }, { name: 'MDB 5', short: 'MDB 5', value: 'MDB5' }];
                    ...
                    case 2:
                        ...
                        licenseChoices = [{ name: 'Free', short: 'Free', value: 'Free' }];
                        if (mdbVersion === 'MDB4')
                    ...
                    case 4:
                        ...
                        this.receiver = new frontend_receiver_1.default(this.context, false);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.entity = technology;
                        this.receiver = new backend_receiver_1.default(this.context, false);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        this.starterCode = starter;
                        this.entity = technology;
                        this.receiver = new wordpress_receiver_1.default(this.context, false);
                        return [2 /*return*/];
                }
            });
        });
    ...
    InitCommand.prototype._getStartersOptions = function (flags, technology) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParamType, queryParamAvailable, loggedin, freeStarters, options, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.context.authenticateUser(false);
                        queryParamType = technology ? "type=" + technology : '';
                        queryParamAvailable = !flags.all ? 'available=true' : '';
                        loggedin = this.context.userToken;
                        freeStarters = loggedin ? '' : '/free';
                        options = __assign({ hostname: config_1.default.host, path: "/packages/starters" + freeStarters + "?" + queryParamType + "&" + queryParamAvailable }, loggedin && { headers: { Authorization: "Bearer " + this.context.userToken } });
