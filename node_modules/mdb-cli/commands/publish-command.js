...
var PublishCommand = /** @class */ (function (_super) {
    ...
    PublishCommand.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.setReceiver()];
                    case 1:
                        _a.sent();
                        flags = this.context.getParsedFlags();
                        if (flags.help)
                            return [2 /*return*/, this.help()];
                        return [4 /*yield*/, this.receiver.publish()];
                    case 2:
                        _a.sent();
    ...
    PublishCommand.prototype.setReceiver = function () {
        return __awaiter(this, void 0, void 0, function () {
            var type;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requireDotMdb()];
                    case 1:
                        _a.sent();
                        if (!this.entity) {
                            type = this.context.mdbConfig.getValue('meta.type');
                            if (type) {
                                this.entity = type;
                        ...
                        switch (this.entity) {
                            ...
                            case entity_1.default.Compose:
                                this.receiver = new compose_receiver_1.default(this.context);
                                break;
                            ...
                            case entity_1.default.Frontend:
                                ...
                                break;
                            default:
                                this.context.entity = entity_1.default.Frontend;
                                this.receiver = new frontend_receiver_1.default(this.context);
                                break;
                        }
    ...
    PublishCommand.prototype.help = function () {
        ...
        this.results.addTextLine('\nFlags:');
        this.results.addTextLine("  -p, --platform \tSpecify the backend platform. Allowed options: " + config_1.default.backendTechnologies.join(', '));
