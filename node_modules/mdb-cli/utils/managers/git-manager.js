...
var GitManager = /** @class */ (function () {
    ...
    GitManager.prototype.clone = function (repoUrl, toCurrentDir) {
        if (toCurrentDir === void 0) { toCurrentDir = false; }
        var gitArgs = toCurrentDir ? ['clone', repoUrl, '.'] : ['clone', repoUrl];
    ...
    GitManager.prototype.pull = function (branchName, printResult) {
        var _this = this;
        if (printResult === void 0) { printResult = true; }
        return new Promise(function (resolve, reject) {
            var _a, _b;
