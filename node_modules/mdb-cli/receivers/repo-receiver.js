...
var RepoReceiver = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._askForProjectName()];
                    case 3:
                        projectName = _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, this._createGitLabPipeline(projectName)];
                    case 5:
                        url = _a.sent();
                        _a.label = 6;
                    case 6:
                    ...
                    case 8:
                        ...
                        if (e_1 && e_1.message && e_1.message.toLowerCase().indexOf('authentication failed') !== -1) {
                            this.result.addAlert(models_1.OutputColor.Blue, 'Note', 'There were some authentication problems. Please make sure you provided correct username and password. If you are certain that the credentials are correct and still see this message, please log into your MDB Go GitLab account to activate it here: https://git.mdbgo.com/. Once you do that run the following command:');
                            this.result.addAlert(models_1.OutputColor.Turquoise, '\tgit push -u origin master', '');
                        }
                        else {
                            this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not create repository: " + e_1.message);
                        }
                        return [3 /*break*/, 9];
    ...
    RepoReceiver.prototype._getProjectName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projectName, isWp, result, e_2, packageJsonEmpty;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        projectName = this.context.mdbConfig.getValue('projectName') || this.context.packageJsonConfig.name;
                        isWp = this.context.mdbConfig.getValue('meta.type') === 'wordpress';
                        if (!(!projectName && !isWp)) return [3 /*break*/, 5];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (webhook === false)
                            this.result.liveAlert(models_1.OutputColor.Red, 'Error', 'GitLab webhook not added.');
                        if (saved === false)
                            this.result.liveAlert(models_1.OutputColor.Red, 'Error', 'Project data not saved.');
                        if (pipeline === false)
                            this.result.liveAlert(models_1.OutputColor.Red, 'Error', 'Jenkins pipeline not created.');
                        if (webhook === false || saved === false || pipeline === false)
                            this.result.addAlert(models_1.OutputColor.Red, 'Error', 'There were some errors. Please write to our support https://mdbootstrap.com/support/');
                        this.result.addAlert(models_1.OutputColor.Green, '\nSuccess', "Project " + name + " successfully created. Repository url: " + url + "\n");
                        return [2 /*return*/, url];
                }
            });
        });
    ...
    RepoReceiver.prototype._askForProjectName = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projectName;
            return __generator(this, function (_a) {
                switch (_a.label) {
