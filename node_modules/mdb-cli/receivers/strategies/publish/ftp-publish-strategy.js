...
var FtpPublishStrategy = /** @class */ (function () {
    ...
    FtpPublishStrategy.prototype.publish = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.buildProject().then(function () { return _this.uploadFiles(); })];
            });
        });
    };
    ...
    FtpPublishStrategy.prototype.buildProject = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, distPath, buildPath, packageJson, isAngular, isReact, isVue, angularJsonPath, angularJson, angularFolder, indexPath, indexHtml, toRename, appJsPath, appJsFile, appJsFile, regex, vueConfigFile, vueConfigContent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = '';
                        ...
                        if (!isAngular) return [3 /*break*/, 3];
                        angularJsonPath = path_1.join(this.cwd, 'angular.json');
                        return [4 /*yield*/, helpers_1.default.deserializeJsonFile(angularJsonPath)];
                    case 1:
                        angularJson = _a.sent();
                        return [4 /*yield*/, this.runBuildScript()];
                    case 2:
                        result = _a.sent();
                        angularFolder = path_1.join('dist', angularJson.defaultProject);
                        indexPath = path_1.join(this.cwd, angularFolder, 'index.html');
                        indexHtml = fs_1.readFileSync(indexPath, 'utf8');
                        indexHtml = indexHtml.replace(/<base href="\/">/g, '<base href=".">');
                        fs_1.writeFileSync(indexPath, indexHtml, 'utf8');
                        toRename = path_1.join(this.cwd, angularFolder);
                        fs_extra_1.moveSync(toRename, buildPath, { overwrite: true });
                        fs_extra_1.moveSync(buildPath, distPath, { overwrite: true });
                        return [3 /*break*/, 11];
                    case 3:
                        if (!isReact) return [3 /*break*/, 7];
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 11];
                    case 7:
                        if (!isVue) return [3 /*break*/, 9];
                        vueConfigFile = path_1.join(this.cwd, 'vue.config.js');
                        if (!fs_1.existsSync(vueConfigFile)) {
                            vueConfigContent = 'module.exports = { publicPath: \'.\' }';
                            fs_1.writeFileSync(vueConfigFile, vueConfigContent, 'utf8');
                        }
                        return [4 /*yield*/, this.runBuildScript()];
                    case 8:
                        result = _a.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, this.runBuildScript()];
                    case 10:
                        result = _a.sent();
