...
var DatabaseReceiver = /** @class */ (function (_super) {
    ...
    DatabaseReceiver.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var database, _a, confirmed, _b, prompt, passwordValue, allFlags, answers, _c, response, err_1, mysqlMsg, mongoMsg, msg;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        _b = Boolean(this.flags.username);
                    ...
                    case 4:
                        confirmed = _b;
                        if (!confirmed) {
                            return [2 /*return*/, this.result.addAlert(models_1.OutputColor.Yellow, 'Warning!', 'Cannot create database without a database user.')];
                        }
                        prompt = inquirer_1.default.createPromptModule();
                        allFlags = this.flags.username && this.flags.password && this.flags.name;
                        if (!allFlags) return [3 /*break*/, 5];
                        _c = {
                    ...
                    case 10:
                        err_1 = _d.sent();
                        return [2 /*return*/, this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not create database: " + (err_1.message || err_1))];
                    case 11:
                        ...
                        this.result.addAlert(models_1.OutputColor.Red, '\nWarning!', "Write down the password to your database as we will never show it again.\n");
                        this.result.addAlert(models_1.OutputColor.Blue, 'Info:', msg + "\n");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 7:
                        err_2 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error:', err_2.message);
                        return [3 /*break*/, 8];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 3];
                    case 2:
                        this.result.addAlert(models_1.OutputColor.Red, 'Error:', 'Please provide valid argument!');
                        _a.label = 3;
