...
var FrontendReceiver = /** @class */ (function (_super) {
    ...
    function FrontendReceiver(context, requireAuth) {
        ...
        _this.context.registerNonArgFlags(['ftp', 'open', 'test', 'ftp-only', 'help', 'override', 'cwd']);
    ...
    FrontendReceiver.prototype.publish = function () {
        return __awaiter(this, void 0, void 0, function () {
            var packageJsonEmpty, result, e_1, packageJsonEmpty_1, result, e_2, strategy, strategy, remoteUrl, useGitlab, strategy_1, strategy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        packageJsonEmpty = this.context.packageJsonConfig.name === undefined;
                        if (!packageJsonEmpty) return [3 /*break*/, 5];
                    ...
                    case 9:
                        ...
                        if (!(this.flags.ftp || this.context.mdbConfig.getValue('publishMethod') === 'ftp')) return [3 /*break*/, 11];
                    ...
                    case 10:
                        ...
                        return [3 /*break*/, 18];
                    case 11:
                        if (!(this.context.mdbConfig.getValue('publishMethod') === 'pipeline')) return [3 /*break*/, 13];
                    ...
                    case 13:
                        ...
                        if (!(remoteUrl !== '')) return [3 /*break*/, 16];
                    ...
                    case 14:
                        useGitlab = _a.sent();
                        if (!useGitlab) return [3 /*break*/, 16];
    ...
    FrontendReceiver.prototype._handlePublication = function (strategy) {
        return __awaiter(this, void 0, void 0, function () {
            var response, _a, message, url, e_3, _b, domain;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        e_3 = _c.sent();
                        if (!(e_3.statusCode === models_1.CliStatus.CONFLICT && e_3.message.includes('project name'))) return [3 /*break*/, 6];
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 10];
                    case 6:
                        if (!([models_1.CliStatus.CONFLICT, models_1.CliStatus.FORBIDDEN].includes(e_3.statusCode) && e_3.message.includes('domain name'))) return [3 /*break*/, 9];
                        this.result.liveAlert(models_1.OutputColor.Red, 'Error', e_3.message);
    ...
    FrontendReceiver.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, downloadToCurrentDir, choices, projectName, _a, project, result, repoUrlWithNicename, projectPath, query, err_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getFrontendProjects()];
                    case 1:
                    ...
                    case 10:
                        err_3 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not download " + projectName + ": " + (err_3.message || err_3));
                        return [3 /*break*/, 11];
                    case 11: return [2 /*return*/];
                }
            });
