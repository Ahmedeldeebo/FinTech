...
var Receiver = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        this.result.addAlert(models_1.OutputColor.Green, 'Success', message);
                        return [3 /*break*/, 6];
                    case 5:
                        err_1 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not rename " + projectName + ": " + err_1.message);
                        return [2 /*return*/];
                    case 6:
                    ...
                    case 8:
                        ...
                        this.result.addAlert(models_1.OutputColor.Green, 'Success', "Project name successfully changed to " + newName);
                        return [2 /*return*/];
                }
            });
        });
    ...
    Receiver.prototype.validateDomain = function (val) {
