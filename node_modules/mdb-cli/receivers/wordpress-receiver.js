...
var WordpressReceiver = /** @class */ (function (_super) {
    ...
    function WordpressReceiver(context, requireAuth) {
        ...
        _this.context.registerNonArgFlags(['advanced', 'open', 'ftp', 'follow', 'help', 'override', 'dummy', 'cwd']);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this.downloadProjectStarter(process.cwd())];
                    case 7:
                        result = _a.sent();
                    ...
                    case 8:
                        e_1 = _a.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not initialize: " + (e_1.message || e_1));
                        return [3 /*break*/, 9];
    ...
    WordpressReceiver.prototype.downloadProjectStarter = function (projectPath) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    WordpressReceiver.prototype.publish = function () {
        return __awaiter(this, void 0, void 0, function () {
            var pageVariant, wpData, strategy, remoteUrl, useGitlab;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(this.flags.ftp || this.context.mdbConfig.getValue('publishMethod') === 'ftp')) return [3 /*break*/, 3];
                        strategy = new publish_1.FtpPublishStrategy(this.context, this.result);
                        return [3 /*break*/, 6];
                    case 3:
                        if (!(this.context.mdbConfig.getValue('publishMethod') === 'pipeline')) return [3 /*break*/, 4];
                    ...
                    case 5:
                        ...
                        _a.label = 6;
                    case 6: return [4 /*yield*/, this._handlePublication(pageVariant, wpData, strategy)];
                    case 7:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    WordpressReceiver.prototype._getWpData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var wpData, projectName, pageName;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wpData = {};
                        projectName = this.context.mdbConfig.getValue('projectName');
                        if (!(!projectName || !this.context.mdbConfig.getValue('wordpress'))) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.askWpCredentials(this.flags.advanced)];
                    case 1:
                        wpData = _a.sent();
                        pageName = wpData.pageName ? wpData.pageName.trim().toLowerCase().replace(/ /g, '-').replace(/[^\w-]+/g, '') : projectName;
                        this.context.mdbConfig.setValue('projectName', pageName);
    ...
    WordpressReceiver.prototype._handlePublication = function (pageVariant, wpData, strategy) {
        return __awaiter(this, void 0, void 0, function () {
            var projectName, email, username, withPipeline, hasDummy, dummy, response, firstPublication, payload, e_2, _a, domain;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        projectName = this.context.mdbConfig.getValue('projectName') || '';
                        ...
                        withPipeline = this.context.mdbConfig.getValue('publishMethod') === 'pipeline';
                        ...
                        hasDummy = ['wp-essential-blog', 'wp-essential-ecommerce', 'wp-essential-blog-ecomm'].includes(pageVariant);
                        dummy = this.flags.dummy;
                        if (dummy && !hasDummy) {
                            return [2 /*return*/, this.result.addAlert(models_1.OutputColor.Red, 'Error', "This WordPress starter does not support -d|--dummy flag. Please remove it in order to proceed.")];
                        }
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 6, , 14]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this._createWpPage(payload, withPipeline)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 4:
                    ...
                    case 6:
                        e_2 = _b.sent();
                        if (!(e_2.statusCode === models_1.CliStatus.CONFLICT && e_2.message.includes('project name'))) return [3 /*break*/, 9];
                        this.result.liveAlert(models_1.OutputColor.Red, 'Error', e_2.message);
                        _a = this;
                    ...
                    case 7:
                        ...
                        this.context.mdbConfig.save();
                        return [4 /*yield*/, this._handlePublication(pageVariant, wpData, strategy)];
                    case 8:
                        _b.sent();
                        return [3 /*break*/, 13];
                    case 9:
                        if (!([models_1.CliStatus.CONFLICT, models_1.CliStatus.FORBIDDEN].includes(e_2.statusCode) && e_2.message.includes('domain name'))) return [3 /*break*/, 12];
                        this.result.liveAlert(models_1.OutputColor.Red, 'Error', e_2.message);
                    ...
                    case 11:
                        ...
                        return [3 /*break*/, 13];
                    case 12:
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not publish: " + (e_2.message || e_2));
                        _b.label = 13;
    ...
    WordpressReceiver.prototype._createWpPage = function (payload, withPipeline) {
        if (withPipeline === void 0) { withPipeline = false; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (withPipeline)
                            this.options.headers['x-mdb-cli-pipeline'] = 'true';
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        ...
                        this.result.addAlert(models_1.OutputColor.Green, 'Success', '');
                        ...
                        this.result.addAlert(models_1.OutputColor.Yellow, 'Note', 'Please write down your username and password now, as we will not show it again.\n');
                        this.result.addAlert(models_1.OutputColor.Turquoise, 'Username:', payload.username);
                        this.result.addAlert(models_1.OutputColor.Turquoise, 'Password:', password);
                        this.result.addTextLine('');
                    ...
                    case 3:
                        e_3 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not create WordPress page: " + e_3.message);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.askWpCredentials = function (advanced) {
        return __awaiter(this, void 0, void 0, function () {
            var prompt, hasProjectName, passwordValue;
            return __generator(this, function (_a) {
                prompt = inquirer_1.default.createPromptModule();
                hasProjectName = this.context.mdbConfig.getValue('projectName');
                passwordValue = '';
                return [2 /*return*/, prompt(__spreadArray(__spreadArray(__spreadArray([], (!hasProjectName ?
                        [{
                                type: 'text',
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        this.result.liveAlert(models_1.OutputColor.Yellow, 'Warning', 'This operation cannot be undone, your project and its database will be permanently deleted.');
                        _b = this.flags.force;
                    ...
                    case 8:
                        err_1 = _c.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not delete " + projectName + ": " + err_1.message);
                        return [2 /*return*/, false];
                    case 9: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, downloadToCurrentDir, choices, projectName, _a, project, result, repoUrlWithNicename, projectPath, query, e_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    case 1:
                    ...
                    case 10:
                        e_4 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not download " + projectName + ": " + (e_4.message || e_4));
                        return [3 /*break*/, 11];
    ...
    WordpressReceiver.prototype._getNameFromArgs = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        err_2 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not kill " + projectName + ": " + err_2.message);
                        return [3 /*break*/, 7];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        err_3 = _c.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error:', err_3.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
    ...
    WordpressReceiver.prototype.logs = function () {
        return __awaiter(this, void 0, void 0, function () {
            var projects, projectsToPrompt, projectName, _a, projectExists, _b, lines, tail, follow, followQuery, linesQuery, io_1, result, parsedResult, err_4;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.getWordpressProjects()];
                    ...
                    case 6:
                        err_4 = _c.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not fetch logs for " + projectName + ": " + err_4.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        err_5 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not restart project " + projectName + ": " + err_5.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        err_6 = _b.sent();
                        this.result.addAlert(models_1.OutputColor.Red, 'Error', "Could not run project " + projectName + ": " + err_6.message);
                        return [3 /*break*/, 7];
                    case 7: return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, JSON.parse(result.body)
                                .filter(function (p) { return p.status === models_1.ProjectStatus.WORDPRESS; })
                                .sort(function (a, b) { return a.editDate < b.editDate; })];
                }
            });
        });
    };
    WordpressReceiver.prototype.getSocket = function () {
